...
const ProductIphone = () => {
    ...
    useEffect(()=> {
        dispatch(ProductCategoryActions.getByCategory('iphone'))
    },[dispatch])
    ...
    return (
        <div>
            ...
            <div className='flex justify-center items-center'>
                <div className='product-news grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-20 my-8  cursor-pointer'>
                 {
